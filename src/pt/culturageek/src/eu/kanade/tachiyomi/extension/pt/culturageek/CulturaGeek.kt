package eu.kanade.tachiyomi.extension.pt.culturageek
...
class CulturaGeek : ParsedHttpSource() {

    override val name = "Cultura Geek"

    override val baseUrl = "https://mangalivre.net"
    ...
    override fun popularMangaRequest(page: Int): Request {
        ...
        val newHeaders = headersBuilder()
            .set("Referer", "$baseUrl/series/index/nome/todos?page=$listPath")
            .build()
        val pageStr = if (page != 1) "page/$page" else ""
        return GET("$baseUrl/series/index/nome/todos?page=$pageStr", newHeaders)
    }
    ...
    override fun latestUpdatesRequest(page: Int): Request {
        val listPath = if (page == 1) "" else "mangas/acao/${page - 1}"
        val newHeaders = headersBuilder()
            .set("Referer", "$baseUrl/$listPath")
            .build()

        val pageStr = if (page != 1) "page/$page" else ""
        return GET("$baseUrl/mangas/acao/$pageStr", newHeaders)
    }
